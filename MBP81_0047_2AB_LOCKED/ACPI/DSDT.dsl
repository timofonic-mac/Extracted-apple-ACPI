DefinitionBlock ("DSDT.aml", "DSDT", 1, "APPLE", "MacBookP", 0x00080001)
{
    /*
     ...
     * required for each:
     */
    External (_SB_.PCI0.EHC2.HRST, MethodObj)    // Warning: Unresolved method, guessing 3 arguments
        ...
        Device (PCI0)
        {
            ...
            Device (IGPU)
            {
                ...
                Method (_DOD, 0, NotSerialized)  // _DOD: Display Output Devices
                {
                    ...
                    If ((NDID == 0x01))
                    {
                        ...
                        Index (TMP1, 0x00) = (0x00010000 | DID1)
                    ...
                    If ((NDID == 0x02))
                    {
                        ...
                        Index (TMP2, 0x00) = (0x00010000 | DID1)
                        Index (TMP2, 0x01) = (0x00010000 | DID2)
                    ...
                    If ((NDID == 0x03))
                    {
                        ...
                        Index (TMP3, 0x00) = (0x00010000 | DID1)
                        Index (TMP3, 0x01) = (0x00010000 | DID2)
                    ...
                    If ((NDID == 0x04))
                    {
                        ...
                        Index (TMP4, 0x00) = (0x00010000 | DID1)
                        Index (TMP4, 0x01) = (0x00010000 | DID2)
                    ...
                    If ((NDID == 0x05))
                    {
                        ...
                        Index (TMP5, 0x00) = (0x00010000 | DID1)
                        Index (TMP5, 0x01) = (0x00010000 | DID2)
                    ...
                    If ((NDID == 0x06))
                    {
                        ...
                        Index (TMP6, 0x00) = (0x00010000 | DID1)
                        Index (TMP6, 0x01) = (0x00010000 | DID2)
                    ...
                    If ((NDID == 0x07))
                    {
                        ...
                        Index (TMP7, 0x00) = (0x00010000 | DID1)
                        Index (TMP7, 0x01) = (0x00010000 | DID2)
                    ...
                    If ((NDID == 0x08))
                    {
                        ...
                        Index (TMP8, 0x00) = (0x00010000 | DID1)
                        Index (TMP8, 0x01) = (0x00010000 | DID2)
            ...
            Device (SBUS)
            {
                ...
                Method (SBLR, 3, Serialized)
                {
                    ...
                    Index (TBUF, 0x00) = DAT0 /* \_SB_.PCI0.SBUS.DAT0 */
                    HSTS = 0x80
                    Local1 = 0x01
                    While ((Local1 < DerefOf (Index (TBUF, 0x00))))
                    {
                        Local0 = 0x0FA0
                        While ((!(HSTS & 0x80) && Local0))
                        {
                ...
                Scope (\_SB)
                {
                    Device (BAT0)
                    {
                        ...
                        Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                        {
                            ...
                            Else
                            {
                                Index (PBST, 0x00) = 0x00
                                Index (PBST, 0x01) = 0xFFFFFFFF
                        ...
                        Method (UBST, 0, NotSerialized)
                        {
                            ...
                            Local0 *= Local2
                            Index (PBST, 0x01) = (Local0 / 0x03E8)
                            \_SB.PCI0.LPCB.EC.SMB0.SBRW (0x0B, 0x0F, RefOf (Local0))
                            Index (PBST, 0x02) = (Local0 * 0x0A)
                            Local1 = 0x00
                            If (PWRS)
                            {
